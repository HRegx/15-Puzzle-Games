...
const [isTop, setIsTop] = useState(1000);
...
return (
          ...
          {pGame && <ShowModal myToggle={pauseGame}/>}
                    ...
                    {showTop && <TopScore _showTop={()=>{setShowTop(false)}}/>}
                    ...
                    <TouchableOpacity onPress={()=>setShowTop(true)} style={style.button}>
                        <Text style={style.buttonText}>TOP TEN BEST PLAYERS</Text>
                    </TouchableOpacity>
                              <Text>ABOUT</Text>
                              <Text>HOW TO</Text>
                    </View>                            
