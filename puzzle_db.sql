CREATE DATABASE  IF NOT EXISTS `puzzle` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `puzzle`;
...
CREATE TABLE `top_score` (
  ...
  `f_screen_name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`f_id`),
...
-- Dump completed on 2023-03-04 20:34:24
